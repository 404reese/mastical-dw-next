      ...
      <div className="container mx-auto text-center">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/1.webp" alt="Tooth Icon" className="mb-4 mx-auto" />
          ...
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/2.webp" alt="Dental Crown Icon" className="mb-4 mx-auto" />
          ...
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/4.webp" alt="Teeth Whitening Icon" className="mb-4 mx-auto" />
          ...
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/3.webp" alt="Dental Implants Icon" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/5.webp" alt="Invisalign Icon" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded shadow-md bg-[#F5F1E4]">
            <img src="/6.webp" alt="Wisdom Teeth Icon" className="mx-auto mb-4" />
        ...
        <a className="mt-8 inline-block border border-teal-600 bg-teal-600 text-white hover:bg-white hover:text-teal-600 py-2 px-4 rounded transition-colors" href="#">
          VIEW ALL SERVICES
        </a>
      </div>
    </section>
